...
export default function CreateRoleModal({ permissions = [], companies = [], onClose }: CreateRoleProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div
        className="relative bg-white rounded-lg shadow-lg max-w-6xl w-full mx-4 h-[90vh] flex flex-col"
        ...
        <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              {errors?.permissions && <p className="text-red-600 text-sm mt-2">{errors.permissions}</p>}
            </div>
          </div>

          {/* Fixed Footer */}
          <div className="flex-shrink-0 flex justify-between p-6 border-t border-gray-200 bg-gray-50">
            <button
              type="button"
              onClick={onClose}
