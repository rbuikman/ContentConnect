...
export default function CreateSubCategoryModal({ onClose, categories }: CreateSubCategoryProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    router.post("/subcategories", { ...form }, {
      onSuccess: () => onClose(),
    });
  };
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-lg shadow-lg w-96 p-6">
        <h2 className="text-lg font-semibold mb-4">Create SubCategory</h2>
